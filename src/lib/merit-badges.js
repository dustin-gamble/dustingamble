        ...
        detailSections: [
            {
                heading: "Executive summary",
                body:
                    "The Scout doesn't invent in a vacuum — they fix something the patrol actually struggles with. Common targets: a chuck box that takes too long to set up, a stove platform that wobbles, a flag stand that won't survive wind, a gear sled for getting kit from the parking lot to the campsite. The project is small enough to finish in a six-week meeting cadence and concrete enough that the patrol immediately benefits.",
            },
            {
                heading: "Phase 1 — Stakeholder interviews and requirements",
                body:
                    "Scout interviews 3–5 patrol members and at least one adult leader. Captures direct quotes about what's painful. Distills those into a needs statement (one paragraph) and 5–8 measurable requirements (e.g., 'fits in the back of a Subaru Outback,' 'sets up in under 90 seconds by one person,' 'weighs less than 30 lb fully loaded').",
            },
            {
                heading: "Phase 2 — Concept trade",
                body:
                    "Two or three concepts sketched by hand. Simple weighted trade matrix scoring each against the requirements. The Scout picks a winner and writes a one-paragraph rationale. This is the deliverable that gets photographed for both badges' notebooks.",
            },
            {
                heading: "Phase 3 — Design and review",
                body:
                    "CAD model (Tinkercad / Fusion 360 / OpenSCAD) or to-scale cardboard mock-up. Cut list, hardware list, and cost estimate. Counselor design review is required before any cutting — this satisfies the explicit pre-build approval on Inventing req 7 and gives a real example for Engineering req 4.",
            },
            {
                heading: "Phase 4 — Build",
                body:
                    "One adult-supervised shop day. The Scout drives every cut and fastener decision; the adult is there for power-tool safety. Every step is photographed for the notebook. If anything deviates from the plan, the deviation is dated and recorded.",
            },
            {
                heading: "Phase 5 — Verification on a real campout",
                body:
                    "The box ships to the next patrol campout. The Scout records, for each requirement, whether it was met, and captures any new pain points. This is the verification step in the systems-engineering loop — without it, the project is incomplete for Engineering req 5.",
            },
            {
                heading: "Phase 6 — Wrap-up",
                body:
                    "Final notebook entry: what worked, what didn't, what would change in v2.0. Discussion of NSPE Code of Ethics next to the Scout Oath and Law (Engineering req 8). Optional: design a small 'mod kit' page so another Scout can rebuild the same box.",
            },
            {
                heading: "Materials and budget",
                list: [
                    "1 sheet ¾\" plywood OR equivalent in 1×6 pine boards (~$45)",
                    "Hinges, latches, handles, T-nuts (~$30)",
                    "Wood glue, screws, finishing supplies (~$15)",
                    "Optional: caster wheels for a gear sled / rolling box (~$25)",
                    "Optional: Tinkercad / Fusion 360 (free for personal / education use)",
                ],
                footer:
